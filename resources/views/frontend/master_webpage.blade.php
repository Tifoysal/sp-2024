...
<body>
    ...
    <!-- ALL PLUGINS -->
    <script src="{{url('frontend/assets/js/jquery.superslides.min.js')}}"></script>
    <script src="{{url('frontend/assets/js/bootstrap-select.js')}}"></script>
    <script src="{{url('frontend/assets/js/inewsticker.js')}}"></script>
    <script src="{{url('frontend/assets/js/bootsnav.js.')}}"></script>
    <script src="{{url('frontend/assets/js/images-loded.min.js')}}"></script>
    <script src="{{url('frontend/assets/js/isotope.min.js')}}"></script>
    <script src="{{url('frontend/assets/js/owl.carousel.min.js')}}"></script>
    <script src="{{url('frontend/assets/js/baguetteBox.min.js')}}"></script>
