    ...
    <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="w-100" src="{{ url('frontend/assets/img/carousel-1.jpg') }}" alt="Image">
                <div
            ...
            <div class="carousel-item">
                <img class="w-100" src="{{ url('frontend/assets/img/carousel-2.jpg') }}" alt="Image">
                <div
                    class="carousel-caption top-0 bottom-0 start-0 end-0 d-flex flex-column align-items-center justify-content-center">
                    <div class="text-start p-5" style="max-width: 900px;">
        ...
        <div class="row gx-5">
            <div class="col-lg-6 mb-5 mb-lg-0">
                <div class="d-flex h-100 border border-5 border-primary border-bottom-0 pt-4">
                    <img class="img-fluid mt-auto mx-auto" src="{{ url('frontend/assets/img/about.png') }}">
                </div>
            </div>
        ...
        <div class="row g-5">
            ...
            <div class="col-lg-6">
                <div class="d-block bg-white h-100 text-center p-5 pb-lg-0">
                    ...
                    <img class="img-fluid" src="{{ url('frontend/assets/img/feature.png') }}" alt="">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="text-white mb-5">
